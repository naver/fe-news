...
React에서 사용하는 커스톰 hook 이다. 유용한 hook이 많이 있으니 개발할 때 만들기 보다 필요한 hook을 찾고 이용해 보자.
...
### @tracked
필드를 보고 있다가 변경 시 render 메서드를 트리거 한다.
```javascript
...
# 새소식
## [vue.js 3.0 One piece release](https://github.com/vuejs/vue-next/releases/tag/v3.0.0)
vue 3.0 공식릴리즈 뷰 3.0의 공식릴리즈가 공개되었다. Progressive framework 컨셉을 지향하는 vue3.0의 새로운 출발을 지목해보자.

## [deno 1.4 release](https://deno.land/posts/v1.4)
웹소켓을 지원하고, 개발환경으로 쓸 수 있는 watch가 지원되네요. 현업에서 쓸 수 있는 날이 머지않아 보입니다.