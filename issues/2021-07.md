...
<div class="wp-block-cp-codepen-gutenberg-embed-block cp_embed_wrapper"><iframe id="cp_embed_YzpeJmG" src="//codepen.io/anon/embed/YzpeJmG?height=450&amp;theme-id=1&amp;slug-hash=YzpeJmG&amp;default-tab=result" height="450" scrolling="no" frameborder="0" allowfullscreen allowpaymentrequest name="CodePen Embed YzpeJmG" title="CodePen Embed YzpeJmG" class="cp_embed_iframe" style="width:500px;overflow:hidden">CodePen Embed Fallback</iframe></div>
