...
웹사이트에 회원 가입과 로그인 기능을 단 몇 줄의 코드를 통해 추가할 수 있게 해준다.<br>
또한 과금 시스템과 소셜 로그인 기능 등도 추가할 수 있다. 가입한 사용자와 팀을 관리할 수 있는 대시보드 기반의 관리 도구도 제공한다.
...
딥러닝 인프라를 구축해야 할 때 고려해야 하는 내용을 자세하게 설명한다.
...
2020년 보다 나은 개발자가 되기 위해 도움 되는 할 책들의 목록을 소개한다.
...
> [참고] 2019년 GitHub Universe를 통해 발표된 [Github Actions](https://github.com/features/actions)는 GitHub 내에서 다양한 workflow를 자동화할 수 있게 도와주는 기능이다.
...
Issue id를 git 커밋 시 자동으로 포함시키는 방법에 대해 설명한다.
