...
> [참고] 저자는 대표 Repository를 기준으로 삼았지만 React, Vue 등은 핵심 기능만 존재하는 반면 Angular는 Monorepo로 구성되어 Router, Localize, Form 등의 기능까지 포함되어 있다. 해당 아티클의 코멘트란에서 더 나은 방법에 대해 토론중인 것을 확인할 수 있다.
