...
`react-i18next`을 활용해 다국어를 지원하는 날씨 애플리케이션을 만들어보자. 만약 국제화(i18n) 설정을 끝내고 자동화를 하고 싶다면 지난 호에 실린 [국제화(i8n) 자동화 가이드](https://github.com/naver/fe-news/blob/master/issues/2021-04.md#%EA%B5%AD%EC%A0%9C%ED%99%94i18n-%EC%9E%90%EB%8F%99%ED%99%94-%EA%B0%80%EC%9D%B4%EB%93%9C)도 좋은 참고 자료가 될 것이다.  
